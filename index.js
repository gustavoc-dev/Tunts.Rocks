...
const workbook = xlsx.readFile('./copy/Cópia de Engenharia de Software - Desafio Gustavo Carvalho.xlsx')
...
xlsx.writeFile(workbook, 'Engenharia de Software - Desafio Gustavo Carvalho.xlsx');